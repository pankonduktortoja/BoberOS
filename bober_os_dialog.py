...
class BoberOSDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        ...
        self.iface = iface
        self.setupUi(self)
        self._init_ui_color_customization()
        ...
        self.pbClearConsole.clicked.connect(self.runClearConsole)
    ...
    def _open_ui_color_slider(self):
        ...
        self._apply_ui_bg_color(color_str)
